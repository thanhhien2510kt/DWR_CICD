...
public class LoginPage extends CommonPage {
    ...
    public void Logout(String username) {
        WebUI.waitForElementVisible(By.xpath("//span[normalize-space()='" + username + "']"), 3);
        
        // Use JS click to bypass the toast message overlay that might cover the username
        WebUI.clickElementWithJs(By.xpath("//span[normalize-space()='" + username + "']"));
        
        // Then click the logout option
        WebUI.clickElementWithJs(optionLogout);
        WebUI.sleep(2);
    }
    ...
    public void verifyLoginSuccess() {
        ...
        Assert.assertEquals(driverManager.getDriver().getCurrentUrl(), "http://20.24.110.171/dwr",
                "FAIL. Cannot redirect to the Dashboard page");
    }
    ...
    public void verifyLoginFail(String expectedMessage) {
        ...
        Assert.assertEquals(WebUI.getElementText(errorMessage), expectedMessage,
                "FAIL.The content of the error message does not match. ");
    }
